    ...
    >
      ...
      <span className="lobby-action-icon relative grid h-20 w-20 shrink-0 place-items-center">
        {iconSrc ? (
          ...
          <span className="grid h-16 w-16 place-items-center rounded-full border-2 border-[#f5d873] bg-gradient-to-b from-[#ffe87b] to-[#b36b12] text-3xl font-black text-[#2a1609] shadow-[0_7px_0_rgba(0,0,0,0.28)]">
            {compactIcon}
          </span>
        )}
      </span>
