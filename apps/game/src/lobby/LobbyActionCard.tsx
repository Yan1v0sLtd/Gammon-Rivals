...
export function LobbyActionCard({
  ...
  >
    ...
    <span className="relative min-w-0 flex-1">
        <span
          className="lobby-action-title block font-display text-[1.45rem] font-black uppercase leading-[0.95] text-white drop-shadow-[0_2px_0_rgba(0,0,0,0.34)] 2xl:text-2xl">
          {title}
        </span>
        <span
          className="lobby-action-subtitle mt-2 block text-sm font-semibold leading-snug text-white/78">{subtitle}</span>
      </span>
