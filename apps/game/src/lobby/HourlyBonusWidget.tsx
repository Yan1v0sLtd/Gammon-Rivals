...
export function HourlyBonusWidget({
  ...
  const pillKind: 'ready' | 'cooldown' | 'unavailable' = !state || !state.is_enabled ? 'unavailable' : canSpin ? 'ready' : 'cooldown';

  return (<div className="lobby-hourly-bonus" aria-label="Hourly bonus wheel">
    ...
    >
      Claim
    </button>) : pillKind === 'cooldown' ? (<div className="lobby-hourly-bonus-pill is-cooldown" aria-live="polite">
