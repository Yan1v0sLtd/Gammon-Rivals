  ...
  >
    ...
    <div
      ...
      style={{
        ...
        color: '#4b2108',
        boxShadow: '0 0 0 2px #8a3d08, 0 0 0 6px #ffb321, 0 18px 36px rgba(0,0,0,0.6), inset 0 4px 0 rgba(255,255,255,0.7), inset 0 -8px 0 rgba(89,38,9,0.25), inset 0 0 45px rgba(95,43,8,0.22)', // Scale-up "emerge" entrance (springy), matching the unlock
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          boxShadow: 'inset 0 0 0 1px rgba(255,255,255,0.25), inset 0 0 24px rgba(120,50,8,0.16)',
        }}
      />
      ...
      {(['tl', 'tr', 'bl', 'br'] as const).map((pos) => {
        ...
        const positional: React.CSSProperties = pos === 'tl' ? {
          top: '-5px',
          left: '-5px',
          borderRight: 0,
          borderBottom: 0,
        ...
        const discPos: React.CSSProperties = pos === 'tl' ? {
          top: '6px',
          left: '6px'
        } : pos === 'tr' ? {
          top: '6px',
        ...
        return (<div key={pos} aria-hidden style={{...base, ...positional}}>
              <span
                style={{
                  position: 'absolute',
                  width: '1.4rem',
                  height: '1.4rem',
                  borderRadius: '50%',
                  background: 'radial-gradient(circle, #fff5a5, #d78416 65%, #7c3508)',
                  boxShadow: 'inset 0 2px 0 rgba(255,255,255,0.55)', ...discPos,
                }}
              />
        </div>);
      })}
      ...
      <div
        ...
        style={{
          ...
          boxShadow: 'inset 0 3px 0 rgba(255,255,255,0.2), inset 0 -3px 0 rgba(0,0,0,0.35), 0 5px 9px rgba(0,0,0,0.32)',
        }}
      >
      ...
      >
          <span
            style={{
              flex: 1,
              height: '2px',
              background: 'linear-gradient(90deg, transparent, rgba(146,70,12,0.55), transparent)',
            }}
          />
        <span>✤</span>
        <span
