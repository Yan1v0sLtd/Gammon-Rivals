      ...
      <div className="flex flex-col items-center gap-2 pointer-events-auto">
        <button
          ...
          className={`relative w-10 h-10 sm:w-12 sm:h-12 rounded-md font-display text-base sm:text-xl shadow-lg border-2 transition
            ${
              canOffer
                ? 'bg-gradient-to-br from-amber-100 to-amber-300 text-amber-950 border-amber-700 hover:brightness-110 active:scale-95 cursor-pointer'
                : 'bg-gradient-to-br from-amber-200/90 to-amber-400/80 text-amber-950 border-amber-800/70 cursor-default'
            }
