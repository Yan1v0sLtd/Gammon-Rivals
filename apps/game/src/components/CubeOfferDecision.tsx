...
export function CubeOfferDecision({
  ...
  return (<div className="absolute inset-0 flex items-center justify-center bg-black/60 z-30">
    <div
      ...
      <div
        className="my-3 inline-flex items-center justify-center w-20 h-20 rounded-lg bg-gradient-to-br from-amber-50 to-amber-200 border-2 border-amber-700 shadow-inner font-display text-3xl">
        {newValue}
      </div>
