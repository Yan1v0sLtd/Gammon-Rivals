...
interface RouteEnteredPayload extends RouteEnteredArgs {
  readonly board: BoardState;
}

interface MatchIdAssignedPayload {
...
interface CheckerSelectedPayload {
  readonly from: Position;
}

interface CheckerMovedPayload {
  readonly from: Position;
...
interface TurnForfeitedPayload {
  readonly endedAt: number;
...
interface GameContinuedPayload {
  readonly board: BoardState;
}
