      ...
      <div className="flex flex-wrap items-end gap-4">
        <div className="min-w-[8rem]">
          <Field
            ...
            onChange={(cooldown_seconds) => setConfigDraft((d) => ({
              ...d,
              cooldown_seconds
            }))}
            disabled={!canManage}
        ...
        <div>
          <Toggle
            ...
            onChange={(is_enabled) => setConfigDraft((d) => ({
              ...d,
              is_enabled
            }))}
            disabled={!canManage}
      ...
      <div className="rounded-xl border border-white/10 bg-white/[0.045] p-4">
        ...
        <div className="mt-3 grid grid-cols-2 gap-3">
          ...
          <Select
            ...
            onChange={(accent_color) => setSlotDraft((d) => ({
              ...d,
              accent_color
            }))}
            disabled={!canManage}
          ...
          <Field
            ...
            onChange={(chance_percent) => setSlotDraft((d) => ({
              ...d,
              chance_percent
            }))}
            disabled={!canManage}
          ...
          <div className="self-end pb-2">
            <Toggle
              ...
              onChange={(is_enabled) => setSlotDraft((d) => ({
                ...d,
                is_enabled
              }))}
              disabled={!canManage}
        ...
        <div className="mt-4 rounded-lg border border-white/10 bg-black/15 p-3">
          ...
          <div className="mt-3 grid grid-cols-2 gap-3">
            ...
            <Field
              ...
              onChange={(primary_reward_amount) => setSlotDraft((d) => ({
                ...d,
          ...
          <div className="mt-3">
            <ImageField
              ...
              onChange={(primary_reward_icon_url) => setSlotDraft((d) => ({
                ...d,
          ...
          {hasSecondary ? (<>
            <div className="mt-3 grid grid-cols-2 gap-3">
              ...
              <Field
                ...
                onChange={(secondary_reward_amount) => setSlotDraft((d) => ({
                  ...d,
            ...
            <div className="mt-3">
              <ImageField
                ...
                onChange={(secondary_reward_icon_url) => setSlotDraft((d) => ({
                  ...d,
                  secondary_reward_icon_url
                }))}
                folder="wheel"
